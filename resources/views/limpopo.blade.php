...
<head>
  ...
  <title>COVID 19 Tracker | Limpopo</title>
...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <h5 class="text-light mt-2"><a href="/home"><span style ="color:white;">COVID-19 Register</span></a></h5>
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li class=""><a href="/recoveries">Recoveries</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="alert alert-primary" role="alert" id="alert">
                <a href="#Capricon" data-toggle="collapse" data-target="#Capricon">Capricon</a>
            </div>
          </div>

          <div class="col-lg-12 collapse" id="Capricon">
            <div class="alert alert-primary" role="alert" id="alert">
            <h5 class="text-center">Capricon</h5>
            <table class="table table-striped mt-5  responsive">
                      <thead>
                        ...
                        <th scope="col"><strong>Recoveries</strong></th>
                        <th scope="col"><strong>Admissions</strong></th>
                        <th scope="col"><strong>Deaths</strong></th>
                        <th scope="col"><strong>Contacts</strong></th>
                        <th scope="col"><strong>Contacts Reached/ Traced</strong></th>
                        <th scope="col"><strong>Symptomatic Contacts</strong></th>
                        <th scope="col"><strong>Contacts Positive</strong></th>
                        <th scope="col"><strong>Contacts Completed</strong></th>
                        </tr>
                    </thead>
                ...
                <table class="table table-striped mt-5  responsive">
                      <thead>
                        <tr>
                        <th scope="col"><strong>Hospital</strong> </th>
                        <th scope="col"><strong>COVID 19 Screening</strong></th>
                        <th scope="col"><strong>Hospitalized</strong></th>
                        <th scope="col"><strong>Beds Capacity</strong></th>
                        <th scope="col"><strong>PPEs</strong></th>
                        <th scope="col"><strong>Quarantined</strong></th>
                        <th scope="col"><strong>Recoveries</strong></th>
                        <th scope="col"><strong>Deaths</strong></th>
                        </tr>
                    </thead>
                    ...
                    <tbody class= "">
                        <tr>
                        <td scope="row"><strong>Polokwane Provincial Hospital</strong></td>
                        <td>100</td>
                        <td>0</td>
                        <td>100</td>
                        <td>0</td>
                        ...
                        <tr>
                        <td scope="row"><strong>Zebediela Government Hospital</strong></td>
                        <td>78</td>
                        <td>0</td>
                        <td>80</td>
                        <td>0</td>
                        ...
                        <tr>
                        <td scope="row"><strong>Medical Hospital of Lebowakgomo</strong></td>
                        <td>50</td>
                        <td>0</td>
                        <td>60</td>
                        <td>4</td>
          ...
          <div class="col-lg-12">
            <div class="alert alert-primary" role="alert" id="alert">
            <a href="#Mopani" data-toggle="collapse" data-target="#Mopani">Mopani</a>
            </div>
          </div>

          <div class="col-lg-12 collapse" id="Mopani">
            <div class="alert alert-primary" role="alert" id="alert">
            <h5 class="text-center">Mopani</h5>
            <table class="table table-striped mt-5  responsive">
                      <thead>
                        <tr>
                        <th scope="col"><strong>Cumulative</strong> </th>
                ...
                <table class="table table-striped mt-5  responsive">
                    ...
                    <tbody class= "">
                        <tr>
                        <td scope="row"><strong>Letaba Hospital</strong></td>
                        <td>100</td>
                        <td>0</td>
                        <td>100</td>
                        <td>0</td>
                        ...
                        <tr>
                        <td scope="row"><strong>Kgapane Hospital</strong></td>
                        <td>78</td>
                        <td>0</td>
                        <td>80</td>
                        <td>0</td>
                        ...
                        <tr>
                        <td scope="row"><strong>Van Velden Hospital</strong></td>
                        <td>50</td>
                        <td>0</td>
                        <td>60</td>
                        <td>4</td>
        ...
        <div class="modal-dialog ">
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <form id="CustomerForm" name="CustomerForm" class="form-horizontal" action ="/addrecovery" method="POST">
                    @csrf
                        ...
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label">Date Tested</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="tested" name="tested" placeholder="Date Confirmed Positive" value="" maxlength="50">
                            </div>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary" id="saveBtn" value="create">Save Recovery
                        </button>
                        </div>
                    </form>
                </div>
