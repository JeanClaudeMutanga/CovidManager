...
<head>
  ...
  <title>COVID 19 Tracking | Add</title>
      ...
      <div class="container">
        <div class="row">
          ...
          <h5 style="color:white;">Patient Details</h5>
             <form method="POST" action="/test" validate>
                  @csrf
                  ...
                  <h5 style="color:white;">Test Location</h5>

                  <div class="form-group row">
                      <div class="col-md-12">
                      <input type="text" class="form-control" name ="district" id="district" placeholder="District" aria-label="District" aria-describedby="basic-addon1" required>
                        <div id="districtList">
                        </div>
                        {{ csrf_field() }}
                      @error('district')
                  ...
                  <div class="form-group row">
                      <div class="col-md-12">
                      <input type="text" class="form-control" name ="town" placeholder="Town" aria-label="Town" aria-describedby="basic-addon1" required>
                      @error('district')
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
                  ...
                  <div class="form-group row">
                      <div class="col-md-12">
                                <select class="custom-select" id="inputGroupSelect02" name="type" required>
                                    ...
                                    <option value="Refereed">Refereed For Testing</option>
                                    <option value="Saved">Saved Case</option>
                                </select>
                      </div>
                  </div>
