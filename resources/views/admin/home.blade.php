  ...
  <header id="header">
    <div class="container">
      ...
      <a href="/home"><img src="/svg/test.png" alt="" class="img-fluid" style="height: 90px;width:100px;"></a>
        <h5 class="text-light mt-2"><a href="/home"><span style ="color:white;">COVID-19 </span></a>| Admin</h5>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            ...
            <div class="icon"><i class='bx bxs-folder-open' style="color: green;"></i></div>
              <span><a href="/facilities/all"><p style="color: green;">QUARANTINE FACILITIES</p></a></span>
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <div class="count-box">
            <div class="icon"><i class='bx bxs-folder-open' style="color: green;"></i></div>
              <span><a href="/admin/users"><p style="color: green;">USER MANAGEMENT</p></a></span>
