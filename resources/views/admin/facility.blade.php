...
<head>
  ...
  <title>COVID 19 Admin | Facilities</title>
...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <h5 class="text-light mt-2"><a href="/home"><span style ="color:white;"> COVID-19 </span></a>| Admin Facilities</h5>
  ...
  <!----Dashboard Section------>
    <section class="counts section-bg">
      <div class="container">
        <div class="row">
          ...
          <hr>
          <a href="#AddFacility" data-toggle="modal" class="btn btn-success btn-md">Add Facility</a>
           ...
           <table class="table table-striped mt-5  responsive">
                    <thead>
                        ...
                        <th scope="col"><strong>Admin</strong></th>
                    ...
                    <tbody class= "">
                        ...
                        <td><a href="/quarantine/{{$facility->id}}" class="btn btn-success btn-md">Open</a></td>
    ...
    <!---Modal--->
<div class="modal fade" id="AddFacility" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content ">
                <div class="modal-header">
                    <h4 class="modal-title" id="modelHeading">Facility Details</h4>
                </div>
                <div class="modal-body">
                    <form id="CustomerForm" name="CustomerForm" class="form-horizontal" action ="/facilities/add" method="POST">
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="address" name="address" placeholder="Enter Address" value="" maxlength="500" required="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="district" name="district" placeholder="District" value="" maxlength="50" required="">
                                <div id="districtList">
                                </div>
                                {{ csrf_field() }}
                            </div>
                        ...
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label">Administrator </label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="admin" name="admin" placeholder="Administrator's Full Name" value="" maxlength="500">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="name" class="col-sm-4 control-label">Capacity</label>
                            <div class="col-sm-12">
                                <input type="number" class="form-control" id="capacity" name="capacity" placeholder="Capacity" value="" maxlength="50">
                            </div>
                        </div>
