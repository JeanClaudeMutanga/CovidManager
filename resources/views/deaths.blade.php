...
<head>
  ...
  <title>COVID 19 Register | Deaths</title>
        ...
        <div class="row">
          ...
          <table class="table table-striped mt-5 text-muted responsive">
                    <thead>
                        ...
                        <th scope="col"><strong>Conditions</strong></th>
                        </tr>
                    </thead>
        ...
        <div class="modal-dialog ">
            <div class="modal-content ">
                <div class="modal-header">
                    <h4 class="modal-title" id="modelHeading">Deceased Details</h4>
                </div>
                <div class="modal-body">
                    <form id="CustomerForm" name="CustomerForm" class="form-horizontal" action ="/newdeath" method="POST">
                    @csrf
                        ...
                        <button type="submit" class="btn btn-primary" id="saveBtn" value="create">Record Death
                        </button>
                        </div>
                    </form>
                </div>
