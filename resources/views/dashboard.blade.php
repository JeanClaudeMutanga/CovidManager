...
<head>
  ...
  <title>COVID 19 Tracking | Dashboard</title>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <div class="count-box" style="background-color:yellow;">
              ...
              <span><a href="#"><h5 style="color: green;">Screened</h5></a></span>
              <p>{{$patients->count()}}</p>
                <br>
                <p></p>
            </div>
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <div class="count-box" style="background-color:yellow;">
              <div class="icon"><i class='icofont-spreadsheet' style="color: green;"></i></div>
              <span><a href="#"><h5 style="color: green;">Confirmed</h5></a></span>
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <div class="count-box" style="background-color:yellow;">
              <div class="icon"><i class='icofont-spreadsheet' style="color: green;"></i></div>
              <span><a href="#"><h5 style="color: green;">Recoveries</h5></a></span>
              <p>{{$recoveries->count()}}</p>
                <br>
                <p></p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <div class="count-box" style="background-color:yellow;">
              <div class="icon"><i class='icofont-spreadsheet' style="color: green;"></i></div>
              <span><a href="#"><h5 style="color: green;">Deaths</h5></a></span>
                <p>{{$deaths->count()}}</p>
                <br>
                <p></p>
            </div>
        ...
        <table class="table table-striped mt-5 responsive" style="color:white;">
                ...
                <tbody class= "">
                  @foreach($districts as $district)
                    <tr>
                    <td scope="row"><strong>{{$district->name}}</strong></td>
                    <td><a href="/district/open/{{$district->id}}" class="btn btn-success btn-md">View</a></td>
                    </tr>
                   @endforeach
