    ...
    <section class="counts section-bg">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="d-flex">
               <a href="/admissions/create" class="btn btn-success btn-md">Back</a>
            </div>
          <hr>
          <h5 class="text-center" style="color:white;">Screened Patients</h5>
         <!--- <button class="btn btn-primary" data-toggle="modal" data-target="#ajaxModel">Add</button> -->
          ...
          <table class="table table-striped mt-5 responsive">
                    <thead>
                        ...
                        <th scope="col"><strong>Mark As</strong></th>
                        </tr>
                    </thead>
                    ...
                    <tbody class= "">
                        ...
                        <td>{{$patient->type}}</td>
                        <td>
                        @if($patient->type=="Quarantined")
                        <p class="text-success">Already Quarantined</p>
                        @else
                          <div class="d-flex">
                            <div>
                              <a href="/confirm/admission/{{$patient->id}}" class="btn btn-success btn-md">Admit</a>
                            </div>
                          </div>
                        @endif
                        </td>
