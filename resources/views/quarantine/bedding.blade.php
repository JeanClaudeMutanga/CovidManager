...
<head>
  ...
  <title>COVID 19 Register | Quarantine </title>
...
<body>
    ...
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li class=""><a href="/give/bed">Allocate Bed</a></li>
          <li class=""><a href="#newBed" data-toggle="modal" data-target="#newBed">Create Bed</a></li>
  ...
  <!----Dashboard Section------>
    <section class="counts section-bg">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
                <hr>
                <h5 class="text-center" style="color:white;">Bed Occupations</h5>
              <!--- <button class="btn btn-primary" data-toggle="modal" data-target="#ajaxModel">Add</button> -->
                @include('layouts.messages')
                    <table class="table table-striped mt-5 responsive">
                          <thead>
                              ...
                              <th scope="col"><strong>Date Allocated</strong></th>
                              </tr>
                          </thead>
                          <tbody class= "">
                            @foreach(auth()->user()->facility->admit as $patient )
                              <tr>
                              <td scope="row"><strong>{{$patient->beds->number}}</strong></td>
                              <td>{{$patient->beds->room}}</td>
                              <td>{{$patient->beds->ward}}</td>
    ...
    <!---Modal--->
    <div class="modal fade" id="newBed" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content ">
                <div class="modal-header">
                    <h4 class="modal-title" id="modelHeading">Bed Details</h4>
                </div>
                <div class="modal-body">
                    <form id="CustomerForm" name="CustomerForm" class="form-horizontal" action ="/create/bed" method="POST">
                    @csrf

                        <div class="form-group">
                            <label for="type" class="col-sm-12 control-label">Bed Number</label>
                        ...
                        <div class="form-group">
                            <label for="type" class="col-sm-12 control-label"> Ward</label>

                            <div class="col-sm-12">
                               <input type="number" class="form-control" name="ward" id="number" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="type" class="col-sm-12 control-label">Room</label>

                            <div class="col-sm-12">
                               <input type="number" class="form-control" name="room" id="number" required>
                            </div>
                        </div>
