              ...
              <!--- <button class="btn btn-primary" data-toggle="modal" data-target="#ajaxModel">Add</button> -->
                @include('layouts.messages')
                    <table class="table table-striped mt-5 responsive">
                          <thead>
                              <tr>
                              <th scope="col"><strong>Currently Occupied </strong> </th>
                          ...
                          <tbody class= "">
                              <tr>
                              <td scope="row"><strong>{{auth()->user()->facility->patients->count()}}</strong></td>
                              <td>{{auth()->user()->facility->capacity}}</td>
                              <td>
                                    <a href="#" class="btn btn-success btn-md">Open</a>
                ...
                <h5 class="text-center" style="color:white;">PPEs</h5>
              <!--- <button class="btn btn-primary" data-toggle="modal" data-target="#ajaxModel">Add</button> -->
                @include('layouts.messages')
                    <table class="table table-striped mt-5 responsive">
                          <thead>
                              <tr>
                              <th scope="col"><strong>Currently Capacity</strong> </th>
                              <th scope="col"><strong>Occupied</strong></th>
                              <th scope="col"><strong>Options</strong></th>
                              </tr>
                          </thead>
                          <tbody class= "">
                              <tr>
                              <td scope="row"><strong>{{auth()->user()->facility->ppes->count()}}</strong></td>
                              <td>{{auth()->user()->facility->ppes->where('patients_id' !="")->count()}}</td>
                              <td>
                                    <a href="/ppes/tracking" class="btn btn-success btn-md">Track</a>               
                              </td>
                              </tr>
                          </tbody>
                    </table>
