...
<head>
  ...
  <title>COVID 19 Tracking | Quarantine</title>
          ...
          <li class="">
            <div class="dropdown show">
                <a class=" dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Referrals</a>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="background-color:green;">
                      <a class="dropdown-item" href="/incoming/referrals">Incoming</a>
                      <a class="dropdown-item" href="/outgoing/referrals">Outgoing</a>
                    </div>
              </div>
          </li>
  ...
  <!----Dashboard Section------>
    <section class="counts section-bg">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
          <form action="/output/filter" method="get">
          ...
          <hr>
          <a href="/admissions/create" class="btn btn-success btn-md">Add Patient</a>
          @include('layouts.messages')
              <table class="table table-striped mt-5  responsive">
                        ...
                        <tbody class= "">
                            <tr>
                            @foreach(auth()->user()->facility->patients as $patient)
                            ...
                            <td><a href="/patient/{{$patient->id}}" class="btn btn-success btn-sm">More</a></td>
        ...
        <div class="modal-dialog ">
            <div class="modal-content ">
                <div class="modal-header">
                    <h4 class="modal-title" id="modelHeading">Personal Details</h4>
                </div>
                <div class="modal-body">
                    <form id="CustomerForm" name="CustomerForm" class="form-horizontal" action ="/test" method="POST">
                    @csrf
                        ...
                        <div class="form-group">
                        <label for="name" class="col-sm-2 control-label">Area Code</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="area" name="area" placeholder="Area Code" value="" maxlength="20" required="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="nationality" name="nationality" placeholder="Nationality" value="" maxlength="50" required="">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="birth" class="col-sm-2 control-label">Birth Place</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="birth" name="birth" placeholder="Place of Birth" value="" maxlength="50" required="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="employer" class="col-sm-2 control-label">Employer Details</label>
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="employer" name="employer" placeholder="Employer Name & Address" value="" maxlength="100">
                            </div>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary" id="saveBtn" value="create">Save & Continue
                        </button>
                        </div>
                    </form>
                </div>
