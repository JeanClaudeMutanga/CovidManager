  ...
  <!----Dashboard Section------>
    <section class="counts section-bg">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
          <form action="/deaths/filter" method="get">
          ...
          <hr>
          <a href="/death/create" class="btn btn-success btn-md">Add New Death</a>
          @include('layouts.messages')
              <table class="table table-striped mt-5  responsive">
                        <thead>
                            ...
                            <th scope="col"><strong>Deceased</strong></th>
                            </tr>
                        </thead>

                        <tbody class= "">
                            <tr>
                            @foreach(auth()->user()->facility->deaths as $patient)
