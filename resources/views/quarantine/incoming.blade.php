    ...
    <section class="counts section-bg">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
          <hr>
          <a href="/admissions/all" class="btn btn-success btn-md">Back</a>
          @include('layouts.messages')
              <table class="table table-striped mt-5  responsive">
                        <thead>
                            <tr>
                            <th scope="col"><strong>Patient Name</strong> </th>
                            <th scope="col"><strong>ID Number</strong></th>
                            <th scope="col"><strong>Referral Facility</strong></th>
                        ...
                        <tbody class= "">
                            <tr>
                            @foreach($referrals->where('recipient_id',auth()->user()->facility->id) as $referral)
                            <td scope="row"><strong>{{$referral->patients->name}}</strong></td>
                            <td>{{$referral->patients_idnumber}}</td>
                            <td>{{$referral->	sending_facility_name}}</td>
                            <td>{{$referral->created_at}}</td>
                            <td>{{$referral->notes}}</td>
                            <td><a href="/patient/{{$referral->id}}" class="btn btn-success btn-sm">Open</a></td>
                            </tr>
                            @endforeach
