    ...
    <section class="counts section-bg">
      <div class="justify-content-center col-lg-12">
        <div class="row">
          <div class="col-lg-12">
            <div class="d-flex">
               <a href="/recoveries" class="btn btn-success btn-md">Back</a>
            </div>
          <hr>
          <h5 class="text-center" style="color:white;">Quarantined Patients</h5>
         <!--- <button class="btn btn-primary" data-toggle="modal" data-target="#ajaxModel">Add</button> -->
          ...
          <table class="table table-striped mt-5 responsive">
                    ...
                    <tbody class= "">
                        <tr>
                        @foreach($patients->where('type','Quarantined') as $patient)
                        ...
                        <td>
                          <div class="d-flex">
                            <div>
                              <a href="/mark/{{$patient->id}}" class="btn btn-success btn-md">Recovery</a>
                            </div>
                          </div>
