...
<head>
  ...
  <title>COVID 19 Quarantine | Add</title>
    ...
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li class=""><a class="btn btn-primary btn-md" href="/main/screened">Add From Screened</a></li>
      ...
      <div class="container">
        <div class="row">
          ...
          <h5 style="color:white;">Patient Details</h5>
             <form method="POST" action="/isolate" validate>
                  @csrf
