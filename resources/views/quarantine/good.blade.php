  ...
  <!----Dashboard Section------>
    <section class="counts section-bg">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
          <form action="/recoveries/filter" method="get">
                <div class="input-group">
                    <input class="form-control" type="search" name="search" placeholder="ID Number Of Existing Quarantined Patient" id="search">
          ...
          <hr>
          <a href="/recoveries/create" class="btn btn-success btn-md">Add New Recovered Patient</a>
          @include('layouts.messages')
              <table class="table table-striped mt-5  responsive">
                        <thead>
                            ...
                            <th scope="col"><strong>Cleared</strong></th>
                            </tr>
                        </thead>

                        <tbody class= "">
                            <tr>
                            @foreach(auth()->user()->facility->recoveries as $patient)
