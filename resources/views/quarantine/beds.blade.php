  ...
  <header id="header">
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          <li><a href="/give/bed">Allocate Bed</a></li>
          <li><a href="/total/beds">Occupied Beds</a></li>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <div class="count-box">
            <div class="icon"><h1 style="color:green;"><strong>{{auth()->user()->facility->capacity}}</strong></h1></div>
              <span><a href="capacity/open"><p style="color: green;">TOTAL CAPACITY</p></a></span>
            </div>
          </div>

          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <div class="count-box">
            <div class="icon"><h1 style="color:green;"><strong>{{auth()->user()->facility->admit->count()}}</strong></h1></div>
              <span><a href="/total/beds"><p style="color: green;">OCCUPIED</p></a></span>
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <div class="count-box">
            <div class="icon"><h1 style="color:green;"><strong>{{$available}}</strong></h1></div>
              <span><a href="#"><p style="color: green;">AVAILABLE</p></a></span>
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <div class="count-box">
            <div class="icon"><h1 style="color:green;"><strong>{{$overflow}}</strong></h1></div>
              <span><a href="#"><p style="color: green;">OVERFLOW</p></a></span>
