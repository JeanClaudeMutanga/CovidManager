        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            ...
            <div class="icon"><i class='bx bxs-folder-open' style="color: green;"></i></div>
              <span><a href="/admissions/all"><p style="color: green;">PATIENTS</p></a></span>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <div class="count-box">
            <div class="icon"><i class='bx bxs-folder-open' style="color: green;"></i></div>
              <span><a href="/stock"><p style="color: green;">STOCK</p></a></span>
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <div class="count-box">
            <div class="icon"><i class='bx bxs-folder-open' style="color: green;"></i></div>
              <span><a href="beds"><p style="color: green;">BED OCCUPATION</p></a></span>
