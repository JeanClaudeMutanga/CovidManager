  ...
  <!----Dashboard Section------>
    <section class="counts section-bg">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
          <form action="/bedding/filter" method="get">
          ...
          @include('layouts.messages')
              <table class="table table-striped mt-5  responsive">
                        <thead>
                            ...
                            <th scope="col"><strong>Bed Status</strong></th>
                        ...
                        <tbody class= "">
                            ...
                            <td>
                            @if($patient->beds_id=="")
                            <p class="text-info">Not Allocated</p>
                            @else
                            <p class="text-info">Allocated</p>
                            @endif
                            </td>
                            <td><a href="/patient/{{$patient->id}}" class="btn btn-success btn-sm">Open</a></td>
