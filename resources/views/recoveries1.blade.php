@extends('layouts.app')
@include('layouts.recoveriesnav')
@section('content')

<div class="col-lg-10 offset-1" id="dash">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <h4 class="text-center"><strong>Recoveries</strong></h4>
            <form action="/filter" method="get">
                <div class="input-group">
                    <input class="form-control" type="search" name="search" placeholder="ID Number/Name" id="search">
