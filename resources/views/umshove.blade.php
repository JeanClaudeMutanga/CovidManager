...
<head>
  ...
  <title>COVID 19 Register | Contacts</title>
  ...
  <!----Dashboard Section------>
    <section class="counts section-bg">
      <div class="d-flex col-lg-12 justify-content-center">
        <div class="row">
          <div class="col-lg-12">
            <h5 class="text-center offset-2" style="color:white;">Contact Tracing</h5>
            ...
            <a class="btn btn-success btn-sm" href="#addcontacts" data-toggle="modal">Add Contacts</a>
            <br>
