...
<head>
  ...
  <title>COVID 19 Tracking | {{$district->name}}</title>
  ...
  /*
      .section-bg{
      background-image: url(svg/custom.jpg);
...
<body>
  ...
  <!----Dashboard Section------>
    <section class="counts section-bg">
      <div class="container">
      <h5 class="text-center mb-1" style="color:white;">{{$district->name}}</h5>
      <br>
        <div class="row">
         
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <div class="count-box" style="background-color:yellow;">
              <div class="icon"><i class='icofont-spreadsheet' style="color: green;"></i></div>
              <span><a href="/district/screened/{{$district->id}}"><h5 style="color: green;">SCREENED</h5></a></span>
              <p>{{$patients->count()}}</p>
                <br>
                <p></p>
            </div>
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <div class="count-box" style="background-color:yellow;">
              <div class="icon"><i class='icofont-spreadsheet' style="color: green;"></i></div>
              <span><a href="/district/refereed/{{$district->id}}"><h5 style="color: green;">REFEREED</h5></a></span>
              <p>{{$patients->where('type', 'Refereed')->count()}} </p>
                <br>
                <p></p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <div class="count-box" style="background-color:yellow;">
              <div class="icon"><i class='icofont-spreadsheet' style="color: green;"></i></div>
              <span><a href="/district/pending/{{$district->id}}"><h5 style="color: green;">PENDING</h5></a></span>
              <p>{{$patients->where('result', 'Pending')->count()}}</p>
                <br>
                <p></p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <div class="count-box" style="background-color:yellow;">
              <div class="icon"><i class='icofont-spreadsheet' style="color: green;"></i></div>
              <span><a href="/district/positive/{{$district->id}}"><h5 style="color: green;">POSITIVE</h5></a></span>
              <p>{{$patients->where('result', 'Positive')->count()}}</p>
                <br>
                <p></p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <div class="count-box" style="background-color:yellow;">
              <div class="icon"><i class='icofont-spreadsheet' style="color: green;"></i></div>
              <span><a href="/district/negative/{{$district->id}}"><h5 style="color: green;">NEGATIVE</h5></a></span>
                <p>{{$patients->where('result', 'Negative')->count()}}</p>
                <br>
                <p></p>
            </div>
          </div> 
        ...
        <table class="table table-striped mt-5 responsive" style="color:white;">
                <thead>
                    <tr>
                    <th scope="col"><strong>Quarantine Facility</strong> </th>
                    <th scope="col"><strong>Capacity</strong></th>
                ...
                <tbody class= "">
                    <tr>
                    @foreach($facilities->where('district',$district->name) as $facility)
                    <td scope="row"><strong>{{$facility->name}}</strong></td>
  ...
  <footer id="footer">
    ...
    <div class="container">
      ...
      <div class="credits">
        ...
        COVID 19 Register <a href="https://afrigoteltech.co.za/">AfrigotelTech</a>
      </div>
    </div>
  </footer><!-- End Footer -->
