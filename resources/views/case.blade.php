...
<head>
  ...
  <title>COVID 19 Register | Results</title>
  ...
  <!----Dashboard Section------>
    <section class="counts section-bg">
      <div class="d-flex col-lg-12 justify-content-center">
        <div class="row">
          <div class="col-lg-12">
            <h5 class="text-center offset-2" style="color:white;">Testing Center</h5>
            <h5 style="color:white;">Case Name: {{$patient->name}} </h5>
            <h5 style="color:white;">ID / Passport Number: {{$patient->idnumber}} </h5>
            ...
            <a class="btn btn-success btn-sm" href="#addcontacts" data-toggle="modal">Update Results</a>
            <br>
        ...
        <div class="modal-dialog ">
            <div class="modal-content ">
                <div class="modal-header">
                    <h4 class="modal-title" id="modelHeading">Update Results</h4>
                </div>
                <div class="modal-body">
                    <form id="CustomerForm" name="CustomerForm" class="form-horizontal" action ="/refereed/update/{{$patient->id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="form-group">
                            <label for="name" class="col-sm-12 control-label">Supporting Documents</label>
                            <div class="col-sm-12">
                                <input type="file" id="age" name="document" required="">
                            </div>
                        </div>
