...
<head>
  ...
  <title>COVID 19 Tracking | Lab Testing</title>
  ...
  <header id="header">
    <div class="container">
      ...
      <a href="/home"><img src="/svg/test.png" alt="" class="img-fluid" style="height: 90px;width:100px;"></a>
        <h5 class="text-light mt-2"><a href="/home"><span style ="color:white;">COVID-19 Lab Testing</span></a></h5>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            <div class="count-box">
            <div class="icon"><i class='bx bxs-folder-open' style="color: red;"></i></div>
              <span><a href="/refereed/all"><p style="color: red;">REFEREED CASES</p></a></span>
