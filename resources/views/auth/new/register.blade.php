...
<head>
  ...
  <title>Red Heart | Register</title>
...
<body>
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container clearfix">
      <div class="contact-info float-left">
        <i class="icofont-envelope"></i><a href="mailto:info@afrigoteltech.co.za">Red Heart Help</a>
        <i class="icofont-phone"></i> +27 10 449 1666
      </div>
  ...
  <header id="header">
    <div class="container">
      ...
      <a href="/"><img src="/svg/test.png" alt="" class="img-fluid" style="height: 90px;width:100px;"></a>
        <h1 class="text-light"><a href="/"><span>Red Heart</span></a></h1>
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li><a href="https://afrigoteltech.co.za">AfrigotelTech Home</a></li>
        </ul>
      </nav><!-- .nav-menu -->
    ...
    <section id="about" class="about">
      <div class="container col-lg-8">
        ...
        <br>
                ...
                <div class="card-header text-center">Get ready to apply for red heart card</div>
                <div class="card-body">
