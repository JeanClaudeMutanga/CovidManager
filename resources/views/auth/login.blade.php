...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <h1 class="text-light"><a href="/"><h5> LIMPOPO COVID 19</h5></a></h1>
  ...
  <div class="jumbotron">
    <div class="container">
    <h4><strong class="text-success">LOG IN TO PROCEED</strong></h4>
    </div>
  </div>
    <!-- ======= About Us Section ======= -->
      ...
      <div class="container">
        ...
        <br>
          <div class="col-lg-3 col-md-6 footer-info">
            <h3>COVID 19 Tracking <p>From<strong> AfrigotelTech</strong></p></h3>
