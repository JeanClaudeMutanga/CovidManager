...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <a href="/"><img src="/svg/test.png" alt="" class="img-fluid" style="height: 90px;width:100px;"></a>
        <h1 class="text-light"><a href="/"><span>COVID 19 Tracking</span></a></h1>
                ...
                <form method="POST" action="{{ route('register') }}" >
                        ...
                        <div class="form-group row">
                            ...
                            <select class="custom-select" id="inputGroupSelect02" name="type" required>
                                    ...
                                    <option value="official">Government/Other</option>
                        ...
                        <div class="form-group row mb-0 offset-3 pl-5">
  ...
  <footer id="footer">
      ...
      <div class="container">
        ...
        <br>
          <div class="col-lg-3 col-md-6 footer-info">
            <h3>COVID 19 Register <p>From<strong> AfrigotelTech</strong></p></h3>
    ...
    <div class="container">
      ...
      <div class="credits">
        COVID 19 Tracker <a href="https://afrigoteltech.co.za/">AfrigotelTech</a>
      </div>
    </div>
  </footer><!-- End Footer -->
