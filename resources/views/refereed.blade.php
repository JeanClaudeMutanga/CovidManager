        ...
        <div class="row">
          <div class="col-lg-12">
              <div class=" d-flex justify-content-center">
                <form action="/lab/search" method="get">
                      <div class="input-group">
                          <input class="form-control" type="search" name="search" placeholder="ID/Passport Number" id="search">
          ...
          <table class="table table-striped mt-5 responsive">
                    ...
                    <tbody class= "">
                        ...
                        <td>
                          <div class="d-flex">
                            <div>
                              <a href="/refereed/open/{{$patient->idnumber}}" class="btn-success btn-sm">Open</a>
                            </div>
                          </div>
                        </td>
                        </tr>
