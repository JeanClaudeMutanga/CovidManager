...
<head>
  ...
  <title>COVID 19 Register | Tracking</title>
    ...
    <section class="counts section-bg">
      <div class="container">
        <div class="row">
          ...
          <h5 class="text-center mb-2" style="color:white;">Monitoring Dashboard</h5>
        ...
        <!---  <button class="btn btn-primary" data-toggle="modal" data-target="#ajaxModel">Add</button> --->
                    ...
                    <table class="table table-striped mt-5  responsive">
                      <thead>
                        ...
                        <th scope="col"><strong>Geo Fence</strong></th>
                        <th scope="col"><strong>Position</strong></th>
                        <th scope="col"><strong>Track</strong></th>
                        <th scope="col"><strong>Status</strong></th>
                        <th scope="col"><strong>Tracking</strong></th>
                        </tr>
                    </thead>

                    <tbody class= "">
                        <tr>
                        @foreach($patients->where('result','Positive') as $patient)
                        ...
                        <td class="text-success"><strong>Safe</strong></td>
                        <td><a href="/monitoring" class="btn btn-info btn-sm">Tracking</a></td>
                        </tr>
                        @endforeach
