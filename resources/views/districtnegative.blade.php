...
<head>
  ...
  <title>COVID 19 Register | Cases</title>
    ...
    <div class="container">
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li class=""><a href="/screening">Screening</a></li>
    ...
    <section class="counts section-bg">
      <div class="justify-content-center col-lg-12">
        <div class="row">
          ...
          <hr>
          <h5 class="text-center" style="color:white;">{{$district->name}} Negative Cases</h5>
         <!--- <button class="btn btn-primary" data-toggle="modal" data-target="#ajaxModel">Add</button> -->
          ...
          <table class="table table-striped mt-5 responsive">
                    ...
                    <tbody class= "">
                        <tr>
                        @foreach($patients->where('result','Negative') as $patient)
                        ...
                        <td>@if($patient->result == "Positive")
                            <p class="text-danger">{{$patient->result}}</p>
                            @elseif($patient->result == "Negative")
                            <p class="text-success">{{$patient->result}}</p>
                            @else
                            <p>Pending</p>
                            @endif
                        </td>
                        <td>
                          <div class="d-flex">
                            <div>
                              <a href="/case/open/{{$patient->idnumber}}" class="btn btn-success btn-md">Open</a>
                            </div>
                          </div>
